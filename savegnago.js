...
const URL = "https://www.savegnago.com.br/api/catalog_system/pub/products/search";
const TAMANHO = 50;
const LIMITE = 2500;
...
async function buscarSavegnago() {
    let produtos = [];
    const ids = new Set();

    for (let inicio = 0; inicio <= LIMITE; inicio += TAMANHO) {
        console.log(`[Savegnago Leme] Buscando ${inicio} - ${inicio + TAMANHO - 1}`);
    ...
    mercado: "Savegnago (Leme)",
    link: "https://www.savegnago.com.br"
});
            }
...
module.exports = buscarSavegnago;